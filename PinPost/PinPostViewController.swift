...
class PinPostViewController: UIViewController {
    ...
    override func viewDidLoad() {
        let favouriteService = FavoriteAPIServivceImpl()
        let favouriteRepository = FavoritePostRepositoryImpl(apiService: favouriteService)
        let pinService = PinPostAPIServiceImpl()
        let pinRepository = PinPostRepositoryImpl(pinAPIService: pinService)
...
extension PinPostViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.bindData(post: post, isFavorite: isFavourited, isPin: isPinned)
        return cell
    }
